...
const pkgdef :Spk.PackageDefinition = (
  ...
  id = "rwpgfzrk72j2c9g7ap2a5qazt8h2v10grtdqu3918ehz8fgm4t8h",
  ...
  manifest = (
    ...
    appTitle = (defaultText = "Trac"),

    appVersion = 1,  # Increment this for every release.

    appMarketingVersion = (defaultText = "1.2.rc1.0"),
    ...
    metadata = (
      ...
      icons = (
        ...
        appGrid = (png = (dpi1x = embed "assets/icon-128.png")),
        grain = (png = (dpi1x = embed "assets/icon-24.png")),
        market = (png = (dpi1x = embed "assets/logo.png")),
      ...
      codeUrl = "https://svn.edgewall.org/repos/trac",
      ...
      author = (
        ...
        upstreamAuthor = "Edgewall Software",
      ...
      screenshots = [
        ...
        (width = 752, height = 563, png = embed "assets/screenshot.png"),
  ...
  #
          description = (defaultText = "grants ability to modify project data"),
  ...
  #
          verbPhrase = (defaultText = "can administrate the project"),
  #        # Brief explanatory text to show in the sharing UI indicating
  #        # what a user assigned this role will be able to do with the grain.
  #
          description = (defaultText = "administrators can modify project data and settings."),
  #        # Prose describing what this role means, suitable for a tool tip or similar help text.
        ),
        (
          title = (defaultText = "user"),
          permissions  = [false],
          verbPhrase = (defaultText = "can use the project"),
          description = (defaultText = "users can add and modify data in the project."),
        ),
      ],
    ),
  #  #apiPath = "/api",
